...
export { SpanAttributes as Attributes } from '@opentelemetry/api/build/src/trace/attributes';
export { SpanKind } from '@opentelemetry/api/build/src/trace/span_kind';
export { TimeInput } from '@opentelemetry/api/build/src/common/Time';
export { SpanStatusCode } from '@opentelemetry/api/build/src/trace/status';
